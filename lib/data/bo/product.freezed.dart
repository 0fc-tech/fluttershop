...
abstract class $ProductCopyWith<$Res> {
  ...
  $Res call(
      ...
      String description,
      @JsonKey(name: "price", fromJson: doublePriceToInt) int priceInCents,
      String image,
      String category});
}
...
class _$ProductImpl extends _Product {
  ...
  @override
  String toString() {
    return 'Product(name: $name, description: $description, priceInCents: $priceInCents, image: $image, category: $category)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, description, priceInCents, image, category);
